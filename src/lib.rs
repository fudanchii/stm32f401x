...
pub static isr_vector: [Vector; 100] = [
    ...
    /* External Interrupts */
    Vector { handler: WWDG_IRQHandler },                    /* Window WatchDog              */
    Vector { handler: PVD_IRQHandler },                     /* PVD through EXTI Line detection */
    Vector { handler: TAMP_STAMP_IRQHandler },              /* Tamper and TimeStamps through the EXTI line */
    Vector { handler: RTC_WKUP_IRQHandler },                /* RTC Wakeup through the EXTI line */
    Vector { handler: FLASH_IRQHandler },                   /* FLASH                        */
    Vector { handler: RCC_IRQHandler },                     /* RCC                          */
    Vector { handler: EXTI0_IRQHandler },                   /* EXTI Line0                   */
    Vector { handler: EXTI1_IRQHandler },                   /* EXTI Line1                   */
    Vector { handler: EXTI2_IRQHandler },                   /* EXTI Line2                   */
    Vector { handler: EXTI3_IRQHandler },                   /* EXTI Line3                   */
    Vector { handler: EXTI4_IRQHandler },                   /* EXTI Line4                   */
    Vector { handler: DMA1_Stream0_IRQHandler },            /* DMA1 Stream 0                */
    Vector { handler: DMA1_Stream1_IRQHandler },            /* DMA1 Stream 1                */
    Vector { handler: DMA1_Stream2_IRQHandler },            /* DMA1 Stream 2                */
    Vector { handler: DMA1_Stream3_IRQHandler },            /* DMA1 Stream 3                */
    Vector { handler: DMA1_Stream4_IRQHandler },            /* DMA1 Stream 4                */
    Vector { handler: DMA1_Stream5_IRQHandler },            /* DMA1 Stream 5                */
    Vector { handler: DMA1_Stream6_IRQHandler },            /* DMA1 Stream 6                */
    Vector { handler: ADC_IRQHandler },                     /* ADC1, ADC2 and ADC3s         */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { handler: EXTI9_5_IRQHandler },                 /* External Line[9:5]s          */
    Vector { handler: TIM1_BRK_TIM9_IRQHandler },           /* TIM1 Break and TIM9          */
    Vector { handler: TIM1_UP_TIM10_IRQHandler },           /* TIM1 Update and TIM10        */
    Vector { handler: TIM1_TRG_COM_TIM11_IRQHandler },      /* TIM1 Trigger and Commutation and TIM11 */
    Vector { handler: TIM1_CC_IRQHandler },                 /* TIM1 Capture Compare         */
    Vector { handler: TIM2_IRQHandler },                    /* TIM2                         */
    Vector { handler: TIM3_IRQHandler },                    /* TIM3                         */
    Vector { handler: TIM4_IRQHandler },                    /* TIM4                         */
    Vector { handler: I2C1_EV_IRQHandler },                 /* I2C1 Event                   */
    Vector { handler: I2C1_ER_IRQHandler },                 /* I2C1 Error                   */
    Vector { handler: I2C2_EV_IRQHandler },                 /* I2C2 Event                   */
    Vector { handler: I2C2_ER_IRQHandler },                 /* I2C2 Error                   */
    Vector { handler: SPI1_IRQHandler },                    /* SPI1                         */
    Vector { handler: SPI2_IRQHandler },                    /* SPI2                         */
    Vector { handler: USART1_IRQHandler },                  /* USART1                       */
    Vector { handler: USART2_IRQHandler },                  /* USART2                       */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { handler: EXTI15_10_IRQHandler },               /* External Line[15:10]s        */
    Vector { handler: RTC_Alarm_IRQHandler },               /* RTC Alarm (A and B) through EXTI Line */
    Vector { handler: OTG_FS_WKUP_IRQHandler },             /* USB OTG FS Wakeup through EXTI line */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { handler: DMA1_Stream7_IRQHandler },            /* DMA1 Stream7                 */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { handler: SDIO_IRQHandler },                    /* SDIO                         */
    Vector { handler: TIM5_IRQHandler },                    /* TIM5                         */
    Vector { handler: SPI3_IRQHandler },                    /* SPI3                         */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { handler: DMA2_Stream0_IRQHandler },            /* DMA2 Stream 0                */
    Vector { handler: DMA2_Stream1_IRQHandler },            /* DMA2 Stream 1                */
    Vector { handler: DMA2_Stream2_IRQHandler },            /* DMA2 Stream 2                */
    Vector { handler: DMA2_Stream3_IRQHandler },            /* DMA2 Stream 3                */
    Vector { handler: DMA2_Stream4_IRQHandler },            /* DMA2 Stream 4                */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { handler: OTG_FS_IRQHandler },                  /* USB OTG FS                   */
    Vector { handler: DMA2_Stream5_IRQHandler },            /* DMA2 Stream 5                */
    Vector { handler: DMA2_Stream6_IRQHandler },            /* DMA2 Stream 6                */
    Vector { handler: DMA2_Stream7_IRQHandler },            /* DMA2 Stream 7                */
    Vector { handler: USART6_IRQHandler },                  /* USART6                       */
    Vector { handler: I2C3_EV_IRQHandler },                 /* I2C3 event                   */
    Vector { handler: I2C3_ER_IRQHandler },                 /* I2C3 error                   */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { reserved: 0 },                                  /* Reserved                     */
    ...
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { handler: FPU_IRQHandler },                     /* FPU                          */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { reserved: 0 },                                  /* Reserved                     */
    Vector { handler: SPI4_IRQHandler },                    /* SPI4                         */
